...
INSERT INTO `testimoniales` VALUES (1,'Orlando','orlando@orlando.gnr','Mi viaje fue excelente'),(2,'Griselda','griselda@orlando.gnr','Me gusto mucho la experiencia'),(3,'Yessica','yessi@orlando.gnr','Fue un excelente viaje, una gran atención, Gracias!'),(4,'Maria del Carmen ','carmen@orlando.gnr','El viaje a Italia fue una gran experiencia, me gusto conocer grandes ciudades como Venecia, sus canales son hermosos, la capital de la moda Milán es una gran ciudad que una vez en la vida se debe conocer');
...
-- Dump completed on 2021-03-12 12:46:32
